...
def main():
   ...
   if "voice_pipeline" not in st.session_state:
        try:
            ...
            st.error(f"Failed to load Voice Pipeline: {e}")
   ...
   with st.sidebar:
       ...
       if not st.session_state.get("workout_started",False):
           ...
           if st.button("Start Workout",width="stretch",key="start_workout_button"):
            ...
            if st.button("End Workout",width="stretch",key="end_workout_button"):
            ...
            st.metric("Current Set Reps",f"{st.session_state.get('current_set_reps')}/{st.session_state.get('reps_per_set')}")
            st.metric("Sets Completed",f"{st.session_state.get('sets_completed')}/{st.session_state.get('target_sets')}")
